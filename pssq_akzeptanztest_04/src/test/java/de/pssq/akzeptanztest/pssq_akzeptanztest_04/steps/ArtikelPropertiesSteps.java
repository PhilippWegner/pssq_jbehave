...
public class ArtikelPropertiesSteps {
	...
	public void thenTheArticlePropertiesShouldBe1Zelt125999(int id, String bezeichnung, int lagerbestand, double preis) {
		Assert.assertTrue("Die Properties sind nicht korrekt.", 
				(this.article.getArtikelID() == id && 
				this.article.getBezeichnung().equals(bezeichnung) &&
